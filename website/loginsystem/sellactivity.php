...
if(isset($_REQUEST["submit"]))
{
	...
	mysql_query("insert into categories(Homes,Vehicles,Computers,Musical,Personal,Clothes,Price,Description,Discount)values('$hom','$vehicle','$computer','$musical','$personal','$clothes','$price','$description','$discount')");
}
?>
<!DOCTYPE html>
<html>
